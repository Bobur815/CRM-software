...
class AddWindow(QDialog):
    def __init__(self,mainWindow):
        ...
        self.setWindowIcon(QIcon("rasmlar/14025467.png"))
    ...
    def save_data(self):
        ...
        with conn.cursor() as cursor:
            cursor.execute("""INSERT INTO mahsulotlar (nomi,klient_nomi,soni,tan_narxi,tan_jami,sotilish_narxi,foiz,sotilish_jami,kelgan_vaqti)  
                           VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s)
                           """,(nomi,klient_id,soni,tannarx,tan_jami,sot_narx,foiz,sot_jami,date))
            conn.commit()
        
        msg = QMessageBox(self)
        msg.information(self,"Muvaffaqiyat","Mahsulot muvaffaqiyatli qo'shildi!")
